...
function setPoloInfo(info) {
  var N_markets = 17;
  var market_str = ['btc_xmr',   'usdt_xmr',   'xmr_bbr',   'xmr_bcn',   'xmr_blk',   'xmr_btcd',   'xmr_dash',   'xmr_diem',   'xmr_ltc',   'xmr_maid',   'xmr_nxt',   'xmr_qora',   'xmr_xdn'];
  var markets = [info.BTC_XMR,info.USDT_XMR,info.XMR_BBR,info.XMR_BCN,info.XMR_BLK,info.XMR_BTCD,info.XMR_DASH,info.XMR_DIEM,info.XMR_LTC,info.XMR_MAID,info.XMR_NXT,info.XMR_QORA,info.XMR_XDN];
